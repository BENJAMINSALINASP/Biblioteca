        ...
        <form action="controlador_create.php" method="post">        
                ...
                <div class="col-md-3">
                    ...
                    <table>
                          <tr>
                            ...
                            <td>
                            <select name="letra" id="" class="form-control">
                                  <?php
            ...
            <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="autor" class="form-control" require>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-3">
                    ...
                    <table>
                          <tr>
                            ...
                            <td>
                            <select name="librerias" id="" class="form-control">
                                  <?php
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <button type="submit" name="save_libro" onclick="return confirm('Confirme si quiere enviar los datos')" class="btn btn-primary">Registrar libro</button>
              </div>
            </div>
          </form>
  </div>
